...
public:
	...
	void build(const unsigned long num_vertices, const unsigned long num_triangles, const std::vector<triangle_t> *triangles, const unsigned long num_edges, const edge_t *edges, const std::vector<vertex> *_verteces);
